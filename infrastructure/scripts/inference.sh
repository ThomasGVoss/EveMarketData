...
export SAGEMAKER_PROJECT_NAME="abalone-inference"
...
python -c "import inference_pipelines" || { echo "Pipelines package not installed correctly"; exit 1; }

run-inference-pipeline --module-name inference_pipelines.abalone.pipeline \
